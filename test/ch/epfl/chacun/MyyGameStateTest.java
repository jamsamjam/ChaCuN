...
class MyyGameStateTest {
    @Test
    void immuable() {
        GameState myGame = initial(List.of(PlayerColor.RED, BLUE),
    ...
    void IllegalArgument() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new GameState(List.of(PlayerColor.RED, BLUE),
                decks, myTile, Board.EMPTY, GameState.Action.OCCUPY_TILE, new MessageBoard(new MessageBoardMaker(), List.of())));
        assertThrows(NullPointerException.class, () -> new GameState(List.of(PlayerColor.RED, BLUE),
    ...
    void currentPlayer() {
        TileDecks decks = new TileDecks(List.of(), List.of(), List.of());
        GameState myGame = new GameState(List.of(PlayerColor.RED, BLUE),
        ...
        GameState myGame1 = new GameState(List.of(PlayerColor.RED, BLUE),
        ...
        GameState myGame2 = new GameState(List.of(PlayerColor.RED, BLUE),
    ...
    void checkWithPlacedTile() {
        ...
        List<PlayerColor> players = List.of(PlayerColor.GREEN, PlayerColor.RED, BLUE);
        ...
        myBoard = myBoard.withNewTile(new PlacedTile(tile54, BLUE, Rotation.NONE, new Pos(-1, 0)));
    ...
    void checkWithPlacedTileCanPlaceNullOccupantLogBoat() {
        ...
        List<PlayerColor> players = List.of(PlayerColor.RED, BLUE, PlayerColor.GREEN);
        ...
        myGame = myGame.withPlacedTile(new PlacedTile(tile55, BLUE, Rotation.NONE, new Pos(2, 0)));
        myGame = myGame.withNewOccupant(null);
        ...
        myBoard = myBoard.withNewTile(new PlacedTile(tile93, BLUE, Rotation.NONE, new Pos(1, 1)));
        nextAction = GameState.Action.OCCUPY_TILE;
        ...
        players = List.of(PlayerColor.RED, BLUE, PlayerColor.GREEN);
        GameState myFinalGame = new GameState(players, myDecks, null, myBoard, nextAction, message);

        GameState myActualGame = myGame.withPlacedTile(new PlacedTile(tile93, BLUE, Rotation.NONE, new Pos(1, 1)));
    ...
    void checkWithPlacedTileCanPlaceNullOccupantHuntingTrap() {
        ...
        myGame = myGame.withPlacedTile(new PlacedTile(tile54, PlayerColor.RED, Rotation.NONE, new Pos(1, 0)));
        myGame = myGame.withNewOccupant(null);
        myGame = myGame.withPlacedTile(new PlacedTile(tile43, BLUE, Rotation.NONE, new Pos(1, -1)));
        myGame = myGame.withNewOccupant(null);
        ...
        myGame = myGame.withNewOccupant(null);
        myGame = myGame.withPlacedTile(new PlacedTile(tile44, BLUE, Rotation.LEFT, new Pos(0, 1)));
        myGame = myGame.withNewOccupant(null);

        myDecks = myGame.tileDecks();
        myBoard = myGame.board();
        myBoard = myBoard.withNewTile(new PlacedTile(tile94, BLUE, Rotation.NONE, new Pos(0, -1)));
        ...
        Area<Zone.Forest> myAreaForest = new Area<>(Set.of(z02, z1, z05, z15, z06, z16), List.of(), 2);
        message = message.withClosedForestWithMenhir(BLUE, myAreaForest);
        message = message.withScoredHuntingTrap(BLUE, myAreaMeadow);
        players = List.of(BLUE, PlayerColor.GREEN, PlayerColor.RED);
        GameState myFinalGame = new GameState(players, myDecks, null, myBoard, nextAction, message);

        GameState myActualGame = myGame.withPlacedTile(new PlacedTile(tile94, BLUE, Rotation.NONE, new Pos(0, -1)));
    ...
    void checkWithPlacedTileCanPlaceOccupant(){
        ...
        myGame = myGame.withPlacedTile(new PlacedTile(tile44, PlayerColor.RED, Rotation.LEFT, new Pos(-1,-1)));
        myGame = myGame.withNewOccupant(null);
        myGame = myGame.withPlacedTile(new PlacedTile(tile02, BLUE, Rotation.LEFT, new Pos(-1,-2)));
        ...
        Area<Zone.Meadow> myAreaMeadow = new Area<>(Set.of(z11, z26, z0, z23, z25), List.of(BLUE), 0);
        Area<Zone.Forest> myAreaForest1 = new Area<>(Set.of(z02, z1, z19, z06, z16), List.of(), 2);
        Area<Zone.Forest> myAreaForest2 = new Area<>(Set.of(z08, z37, z01, z15), List.of(BLUE), 0);
    ...
    public void checkWithFinalPointsCounted() {
        ...
        myBoard = myBoard.withNewTile(new PlacedTile(tile43, BLUE, Rotation.NONE, new Pos(1,-1)));
        ...
        myBoard = myBoard.withNewTile(new PlacedTile(tile02, BLUE, Rotation.LEFT, new Pos(-1,-2)));
        ...
        message = message.withClosedForestWithMenhir(PlayerColor.RED, myAreaForest2);
        players = List.of(BLUE, PlayerColor.GREEN, PlayerColor.RED);
        message = message.withWinners(Set.of(BLUE), 8);
