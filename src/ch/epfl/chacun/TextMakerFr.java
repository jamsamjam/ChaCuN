...
public final class TextMakerFr implements TextMaker, Serializable {
    ...
    // TODO Une méthode privée pour factoriser le code de la fermeture d’aires aurait été judicieuse
    ...
    public String points(int points) {
        ...
        return STR."\{points} \{points < 2 ? "point" : "points"}";
        //return  ? STR."\{points} point" : STR."\{points} points";
    }
    ...
    private static final Map<Animal.Kind, String> ANIMAL_NAME =
            java.util.Map.of(MAMMOTH, "mammouth",
                    AUROCHS, "auroch",
                    DEER, "cerf");
